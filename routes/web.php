...
Route::get('/subscribe', [SubscriptionController::class, 'subscribe'])->middleware('auth')->name('subscribe');
...
Route::get('/job/create', [PostJobController::class, 'create'])->middleware(isPremiumUser::class)->name('job.create');
